...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { notes: @problem.notes, report: @problem.report, resolved: @problem.resolved } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { notes: @problem.notes, report: @problem.report, resolved: @problem.resolved } }
